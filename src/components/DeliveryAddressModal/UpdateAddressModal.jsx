...
import { updateAccountDelivery } from "../../services/accountDelivery/updateAccountDelivery";
...
const UpdateAddressModal = ({
  ...
  const [isDefault, setIsDefault] = useState(initiateAddress?.IsDefault);
  ...
  useEffect(() => {
    setNewAddress({
      name: initiateAddress?.DeliveryAddress?.Name,
      phone: initiateAddress?.DeliveryAddress?.PhoneNumber,
      province: initiateAddress?.DeliveryAddress?.Province,
      address: initiateAddress?.DeliveryAddress?.Address,
    });
    setIsDefault(initiateAddress?.IsDefault);
    setErrors({});
  }, [initiateAddress]);
  ...
  const handleUpdateAddress = async () => {
    ...
    try {
      console.log("Updateing address:", address);
      await updateAccountDelivery(
        initiateAddress?.ID,
        address
      );
      onSuccess();
