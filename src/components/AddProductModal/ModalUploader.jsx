...
import { UploadFile as UploadFileIcon, Close as CloseIcon, Replay as ReplayIcon } from '@mui/icons-material';
  ...
  return (
    <div>
      <Typography variant="body2" color="textSecondary" gutterBottom>
        Mô hình 3D (GLB) <span style={{ color: 'red' }}>*</span>
      </Typography>
      ...
      {!model ? (
        ...
        >
          ...
          <Box sx={{ padding: 1, backgroundColor: 'white', borderTop: '1px solid', borderColor: 'grey.300' }}>
